...
fn test_struct_enum() {
    ...
    assert_snapshot!(go_away::registry_to_output::<go_away::KotlinType>(&registry));
}
*/
...
fn type_aliases() {
    ...
    assert_snapshot!(go_away::registry_to_output::<go_away::KotlinType>(&registry), @r###"
    typealias MyType = Map<String, Long>
    "###);
}
